...
<body>
    ...
    <!-- ======================================= -->
    <script>
        // Renderização imediata das perguntas para evitar tela em branco
        ...
        function verificarQRCodeURL() {
            ...
            if (placaDaURL) {
                ...
                if(inputPlaca) {
                    ...
                    if(hint) {
                        hint.innerText = "✅ Placa identificada pelo QR Code.";
    ...
    <script type="module">
        ...
        async function initializeDatabaseConnection() {
            try {
                ...
                window.showMessage("Erro de Conexão", "Não foi possível conectar ao banco de dados na nuvem.");
            }
        }
        ...
        // Inicializar banco após carregamento
